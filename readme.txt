...
*To use this plugin, you need to create an API key. You can do this via your EmailOctopus account. You can get a free account from the [EmailOctopus](https://emailoctopus.com/) website. The free account allows you use 2500 active subscribers and has a few limitations on the account features.*
